...
public class OpenWthrMap_Page extends BasePage {
	...
	public OpenWthrMap_Page() throws IOException {
		super();
	}
	
	public OpenWthrMap_Page clickOnProceedButton_Popup() throws IOException, InterruptedException {
		waitAndClickElement(button_Proceed_Popup);
		return new OpenWthrMap_Page();
	}
